...
# --- Configuration ---
SPECIES_NAME = 'F. pennanti'
MIN_FILES_PER_LOCATION = 10
SEED = 42

# User-Requested Location Order
# Note: 'Jodpur' in user request -> 'Jodhpur' in data likely.
LOCATION_ORDER = ['Pune', 'Jodhpur', 'New Delhi', 'Chandigarh']
...
LOCATION_COLORS = {
    'Pune': TAB10[0],        # Blue
    'Jodhpur': TAB10[1],     # Orange
    'New Delhi': TAB10[2],   # Green
    'Chandigarh': TAB10[3]   # Red
}
...
def plot_feature_boxplots(df, features, target_col, output_dir, location_order, location_colors):
    # Simplified Boxplots: No significance bars (Stats in CSV)
...
print(f"\n=== F04C {SPECIES_NAME} Analysis Complete ===")
